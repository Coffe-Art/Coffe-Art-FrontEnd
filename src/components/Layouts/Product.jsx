    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-white">
      ...
      <div className="md:w-1/4 lg:w-1/6 bg-cover bg-center p-4 text-white flex flex-col items-center justify-center" style={{ backgroundImage: `url(${BackgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <nav className="flex flex-col items-center space-y-6">
          <NavLink to="/menu" className="text-2xl md:text-3xl text-white hover:text-darkyellow font-bold">Menú</NavLink>
          <NavLink to="/profile" className="text-2xl md:text-3xl text-white hover:text-darkyellow font-bold">Perfil</NavLink>
          <NavLink to="/product" className="text-2xl md:text-3xl text-white hover:text-darkyellow font-bold">Producto</NavLink>
          <NavLink to="/help" className="text-2xl md:text-3xl text-white hover:text-darkyellow font-bold">Ayuda</NavLink>
          <button
            className="bg-darkyellow text-white px-4 py-2 rounded hover:bg-lightyellow mt-4 text-xl md:text-2xl font-bold"
